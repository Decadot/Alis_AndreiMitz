    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-8 relative overflow-hidden">
        ...
        <div class="max-w-md w-full relative z-10">
            <div class="text-center mb-8">
                ...
                <p class="text-soft-lavender text-lg">Sign in to continue</p>
            </div>
            ...
            <div class="card rounded-3xl p-8 shadow-2xl">
                    ...
                    <div class="space-y-5">
                        <div class="field">
                            <input type="text"
                                   id="username"
                                   name="username"
                                   class="input-field w-full px-4 py-3.5 rounded-xl text-gray-800 placeholder-transparent focus:outline-none"
                                   placeholder="Username"
                                   autocomplete="username"
                                   required>
                            <label class="float-label" for="username">
                        ...
                        <div class="field">
                            <input type="password"
                                   id="password"
                                   name="password"
                                   class="input-field w-full pl-4 pr-12 py-3.5 rounded-xl text-gray-800 placeholder-transparent focus:outline-none"
                            ...
                            <button type="button" aria-label="Toggle password visibility" onclick="togglePwd()" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="<?php echo site_url('auth/register'); ?>" class="text-sky-blue hover:text-royal-violet font-semibold transition-colors">
                            Register here
                        </a>
                    </p>
                </div>
